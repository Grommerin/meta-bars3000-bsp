...
# PACKAGE_EXCLUDE += " packagegroup-base-alsa packagegroup-base-zeroconf"
...
IMAGE_INSTALL_append += " bash acl attr bc coreutils cpio e2fsprogs ed file findutils gawk gmp grep makedevs mc mc-fish mc-helpers mc-helpers-perl mc-helpers-python mktemp ncurses net-tools pax popt procps psmisc sed tar time util-linux zlib"
...
# IMAGE_INSTALL_remove +=" alsa neard avahi bluez5 flac packagegroup-base-bluetooth" 
